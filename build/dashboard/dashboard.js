...
async function setWinner(winnerId, winnerButton) {
    ...
    try {
        ...
        alert(
            "Nije uspjelo postavljanje pobjednika. Molim te pokušaj ponovno."
        );
    } finally {
...
async function createCompetitionsHtml(user, compId = undefined) {
    ...
    const competitionElement = await createCompetitionElement(
        competition,
        user
    );
...
function displayUsers(users) {
    ...
    users.forEach((user, index) => {
        ...
        deleteUserButton.addEventListener("click", async () => {
            ...
            alert(
                userDeletion.message || "Greška prilikom brisanja korisnika."
            );
        });
        ...
        assignAdminButton.addEventListener("click", async () => {
            ...
            alert(
                adminAssignment.message ||
                    "Greška prilikom dodijeljenja korisniku."
            );
        });
        ...
        showCompetitionButton.addEventListener("click", () =>
            showCompetition(id)
        );
